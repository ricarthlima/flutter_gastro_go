import '../services/api/assets_api_service.dart';
import '../services/api/i_api_service.dart';
import '../services/i_prefs_storage_service.dart';
import '../services/shared_prefs_storage_service.dart';
import '../../features/dish/data/repositories/dish_repository.dart';
import '../../features/dish/data/repositories/i_dish_repository.dart';
import '../../features/dish/data/services/dish_service.dart';
import '../../features/dish/data/services/i_dish_service.dart';
import '../../features/dish/domain/usecases/usecases.dart';
import '../../features/favorite/data/repositories/i_favorite_repository.dart';
import '../../features/favorite/data/repositories/objectbox_favorites_repository.dart';
import '../../features/restaurant/data/repositories/i_restaurant_repository.dart';
import '../../features/restaurant/data/repositories/restaurant_repository.dart';
import '../../features/restaurant/data/services/i_restaurant_service.dart';
import '../../features/restaurant/data/services/restaurant_service.dart';
import '../../features/restaurant/presentation/stores/restaurant_list_store.dart';
import '../../features/settings/data/repositories/i_settings_repository.dart';
